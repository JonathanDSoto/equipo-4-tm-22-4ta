                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="POST" action="<?=BASE_PATH?>Controlador-etiquetas">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre de Etiqueta" aria-label="Username" aria-describedby="basic-addon1" v-if="mostrar_inputs_añadir == true" name="name" >
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Descripción" aria-label="Username" aria-describedby="basic-addon1" v-if="mostrar_inputs_editar == true" name="description" :value="datos_tag.description">
