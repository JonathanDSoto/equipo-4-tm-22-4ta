	...
	if ( isset($_POST['global_token']) && 
		...
		switch ($_POST['action']) {
			...
			case 'nuevoCupon':
				...
				$couponsController->newCoupon($name,$code,$percetage_discount,$min_amount_required,$min_product_required,$start_date,$end_date,$max_uses,$count_uses,$valid_only_first_purchase,$status);
            ...
            case 'editarCupon':
				...
				$couponsController->editCoupon($name,$code,$percetage_discount,$min_amount_required,$min_product_required,$start_date,$end_date,$max_uses,$count_uses,$valid_only_first_purchase,$status,$id);
...
//Nueva Coupon
	public function newCoupon($name,$code,$percetage_discount,$min_amount_required,$min_product_required,$start_date,$end_date,$max_uses,$count_uses,$valid_only_first_purchase,$status)
	{
...
//Editar Cupones
    public function editCoupon($name,$code,$percetage_discount,$min_amount_required,$min_product_required,$start_date,$end_date,$max_uses,$count_uses,$valid_only_first_purchase,$status,$id)
	{
        ...
        curl_setopt_array($curl, array(
            ...
            '&start_date='.$start_date.'&end_date='.$end_date.'&max_uses='.$max_uses.'&count_uses='.$count_uses.
            '&valid_only_first_purchase='.$valid_only_first_purchase.'&status='.$status.'&id='.$id,
            CURLOPT_HTTPHEADER => array(
                'Authorization: Bearer '.$_SESSION['token'],
