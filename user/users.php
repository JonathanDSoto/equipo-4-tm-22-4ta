                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="POST" action="<?= BASE_PATH ?>Controlador-usuarios" >
                            ...
                            <div class="input-group mb-3">
                                ...
                                <!-- Input al crear -->
                                <input type="text" class="form-control" placeholder="Numero" aria-label="Username" 
                            ...
                            <div class="input-group mb-3">
                                ...
                                <!-- Input al crear -->
                                <input type="text" class="form-control" placeholder="Creado por" aria-label="Username" 
                            ...
                            <div class="input-group mb-3">
                                ...
                                <!-- Input para crear y editar, para asi no mostrar la contraseña actual -->
